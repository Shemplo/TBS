...
* Добавить просмотр информации по облигации в режиме реального времени в самом приложении (после того, как оно уже запущено из лончера)
* Добавить колонку в таблицу с облигациями, которая будет показывать, является ли облигация инструментом, добавленным в избранное
* Добавить колонку в таблицу с облигациями, которая будет показывать дисперсию цены за последний месяц/неделю
